...
<head>
    ...
    <title>Confirm Setup/Payment Intent</title>
</head>

<body>
    <div class="mt-4">
        <form id="intent-form" class="max-w-lg mx-auto">
            <h1 class="text-3xl font-bold text-orange-500 mb-4">Confirm Setup/Payment Intent</h1>
            <div class="mb-5">
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900">Setup/Payment Intent Id
                        <input type="text" name="intent_client_secret"
